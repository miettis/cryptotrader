...
namespace CryptoTrader.Data.Migrations
{
    ...
    [Migration("20241111145018_PriceStreak")]
    partial class PriceStreak
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CryptoTrader.Data.PriceStreak", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_price_streak");

                    b.HasIndex("CryptoId")
                        .HasDatabaseName("ix_price_streak_crypto_id");

                    b.ToTable("price_streak", (string)null);
                });
            ...
            modelBuilder.Entity("CryptoTrader.Data.PriceStreak", b =>
                {
                    b.HasOne("CryptoTrader.Data.Crypto", "Crypto")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_price_streak_crypto_crypto_id");
