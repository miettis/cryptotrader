...
namespace CryptoTrader.Data.Migrations
{
    ...
    [Migration("20240217132348_Initial")]
            ...
            modelBuilder.Entity("CryptoTrader.Data.Features.PriceCycles", b =>
                {
                    ...
                    b.Property<decimal?>("EhlersAutoCorrelationPeriodogram")
                        .HasPrecision(35, 15)
                        .HasColumnType("numeric(35,15)")
                        .HasColumnName("eacp");
                    ...
                    b.Property<decimal?>("EhlersDiscreteFourierTransformSpectralEstimate")
                        .HasPrecision(35, 15)
                        .HasColumnType("numeric(35,15)")
                        .HasColumnName("edftse");
            ...
            modelBuilder.Entity("CryptoTrader.Data.Features.PriceReturn", b =>
                {
                    ...
                    b.OwnsOne("CryptoTrader.Data.Features.ReturnValue", "Month", b1 =>
                        {
                            b1.Property<long>("PriceReturnId")
                                .HasColumnType("bigint")
                                .HasColumnName("id");
                            ...
                            b1.Property<int?>("Interval")
                                .HasColumnType("integer")
                                .HasColumnName("month_interval");

                            b1.Property<decimal?>("Return")
                                .HasPrecision(35, 15)
                                .HasColumnType("numeric(35,15)")
                                .HasColumnName("month_return");
